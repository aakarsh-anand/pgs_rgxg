                ...
                y[3] = (c>>6)&mask2;
				        ...
				        bin_pointer=pointer_bins[bin_index];
                                     ...
                                     if(use_mailman==true){
                                        ...
                                        //  cout << "in read_bed2: bin_index: " << bin_index << "snp_index: "<< snp_index << endl; // step by step update
...
MatrixXdr  compute_XXy (int num_snp,MatrixXdr y_vec){
	...
	///GxG
        cout << "In compute_XXy, num_snp is: " << num_snp << "; sel_snp_local_index is: " << sel_snp_local_index << endl;
